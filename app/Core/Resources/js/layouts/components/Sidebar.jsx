...
export function AppSidebar({ menu = {}, user}) {
                        ...
                        <SidebarMenuButton size="lg" asChild>
                            <a href="/admin/dashboard" className="flex items-center gap-3">
                                <div className="flex aspect-square size-8 items-center justify-center rounded-lg overflow-hidden">
                                    {appFavicon ? (
                                        <img src={appFavicon} alt={settings?.app_name} className="h-full w-full object-contain" />
                                    ) : (
                                ...
                                <div className="grid flex-1 text-left text-sm leading-tight">
                                    <span className="truncate font-bold text-lg">{settings?.app_name}</span>
                                </div>
                            </a>
                        </SidebarMenuButton>
                    </SidebarMenuItem>
                                ...
                                {items.map((item) => {
                                    ...
                                    return (
                                        <SidebarMenuItem key={item.label}>
                                            <SidebarMenuButton asChild isActive={window.App?.currentRoute === item.route} tooltip={item.label}>
                    ...
                    <SidebarMenuItem>
                        <DropdownMenu>
                            ...
                            >
                                ...
                                <DropdownMenuSeparator />
                                <DropdownMenuItem asChild isActive={window.App?.currentRoute === 'admin.profile.index'}>
                                    <a href="/admin/profile" className="cursor-pointer">
                                        <User className="mr-2 h-4 w-4" />
                                        <span>{__('Mon Profil')}</span>
                                    </a>
                                </DropdownMenuItem>
                                <DropdownMenuItem asChild isActive={window.App?.currentRoute === 'admin.settings.index'}>
